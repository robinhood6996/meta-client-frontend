...
import {useDeleteVerificationMutation} from '../../../../redux/features/api/verification/verificationApi'
import {
...
export default function ReportList({className}) {
  ...
  useEffect(() => {
    if (!search) {
      navigate(`/reports?limit=${limit}&offset=0`)
    } else {
  ...
  //api call
  const [updateReport, {isLoading: verificationLoading, isSuccess: vSuccess, isError: vIsError}] =
    useUpdateReportMutation()
  const {data, isFetching, isError, isSuccess} = useGetReportsQuery(query, {skip: !query})
  const [
    deleteVerification,
      ...
      <div className={`card ${className}`}>
        ...
        <div className='card-header border-0 pt-5'>
          <h3 className='card-title align-items-start flex-column'>
            <span className='card-label fw-bold fs-3 mb-1'>Fake photo report list</span>
