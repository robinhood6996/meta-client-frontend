...
const rows: Array<{description: string; path: string}> = [
  ...
  {description: 'Escorts', path: '/active-escorts'},
  {description: 'Escort Advertisements', path: '/active-escort-ads'},
  {description: 'Banner Advertisements', path: '/active-escort-banner-advertisement'},
]
